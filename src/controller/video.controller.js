...
const publishAVideo = asyncHandler(async (req, res) => {
    ...
    const thumbnailUpload = await uploadOnCloudinary(req.files.thumbnailUpload[0]?.path)
    ...
    return res.status(201).json(new ApiResponse(201,video,"Video published succesfully"))
